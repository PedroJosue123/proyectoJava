...
public class informacionequipotecnico extends javax.swing.JFrame {
    ...
    public informacionequipotecnico() {
        initComponents();
        user = Login.usuario;
        IDequipo = gestion_clientes.IDcliente_update;
    ...
    private void initComponents() {
        ...
        jLabel_Nombre6.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        jLabel_Nombre7.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        jLabel_Nombre8.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        jLabel_Nombre8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_Nombre8.setText("Daño reportado y observaciones:");
        getContentPane().add(jLabel_Nombre8, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 120, -1, -1));

        jLabel_revisionTecnicaDe.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        getContentPane().add(jLabel_revisionTecnicaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 140, 330, 120));

        jScrollPane2.setViewportView(jTextPane_comentariosTecnico);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 290, 330, 120));
        ...
        txt_ultima_Modificacion.setBackground(new java.awt.Color(51, 51, 51));
        txt_ultima_Modificacion.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        getContentPane().add(txt_ultima_Modificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, 210, 30));

        txt_fecha.setBackground(new java.awt.Color(51, 51, 51));
        txt_fecha.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        ...
        getContentPane().add(txt_fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 80, 180, 30));

        cmb_tipoequipo.setBackground(new java.awt.Color(51, 51, 51));
        cmb_tipoequipo.setForeground(new java.awt.Color(255, 255, 255));
        cmb_tipoequipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptop", "Desktop", "Impresora", "Multifuncional" }));
        getContentPane().add(cmb_tipoequipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 120, 30));

        cmb_marcas.setBackground(new java.awt.Color(51, 51, 51));
        cmb_marcas.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(cmb_marcas, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 90, 30));

        cmb_estatus.setBackground(new java.awt.Color(51, 51, 51));
        ...
        getContentPane().add(cmb_estatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 80, 130, 30));

        jButton_Actualizar.setBackground(new java.awt.Color(51, 51, 51));
        jButton_Actualizar.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        ...
        getContentPane().add(jButton_Actualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 440, 210, 35));

        jLabel_Wallpaper.setBackground(new java.awt.Color(51, 51, 51));
        jLabel_Wallpaper.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
